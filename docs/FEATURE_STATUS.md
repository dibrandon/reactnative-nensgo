...
| `011-compact-catalog-card-alignment` | Compact catalog card alignment | In Progress | Refining the catalog card and list density so `Explorar` feels closer to the public NensGo browsing reference on a phone. |
