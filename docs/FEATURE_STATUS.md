...
| `013-card-media-aspect-fix` | Card media aspect fix | In Progress | Fixing the remaining stretched-card regression by constraining the media container instead of relying on the image's intrinsic ratio. |
