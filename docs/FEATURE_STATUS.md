...
| `012-public-card-correction` | Public card correction for native explore | In Progress | Correcting the browse card hierarchy against the supplied screenshots and tightening the `Explorar` header while keeping favorites local to the explore stack. |
